    ...
    <section id="home" name="home" className=" home-bg ">
      ...
      <div className="flex flex-col items-center mx-auto justify-center py-48 text-white ">
        ...
        <div className="Details py-12">
          <div className=" ">
            <h1 className="md:text-5xl text-3xl text-center tracking-widest ">UNNIKRISHNAN C</h1>
          ...
          <div className="flex mx-auto items-center justify-center mt-5  " >
            <buttmx className="p-3 w-[130px] rounded-lg custom_btn font-bold mr-5" >Download CV</buttmx>
            <button className="p-3  w-[130px] rounded-lg custom_btn font-bold ml-5" ><Link to={"Projects"} smooth duration={200}  >MY WORKS</Link></button>
          </div>
          ...
          <div className="flex justify-center bottom-0  mt-14">
           <Link to={"about"} smooth duration={500} > <FaAnglesDown className="text-white text-5xl hover:scale-125 " /></Link>
          </div>
        </div>
      </div>
    </section>
